...
//This example shows the fundamentals of scaling images through time.
//In this code, the image "nicerlandscape" is scaled with nearest-neighbor, with the scaling factor linearly interpolated between 0.1 and 1, over a course of 5 seconds
//Lastly, there is a demonstration of how to non-destructively "pause" the code
